...
import { MayaAuthProvider, useMayaAuth, isFullyAuthorized } from './context/MayaAuthContext';
import MayaGateway from './components/maya/MayaGatewayComplete';
import LoginScreen from './pages/login/LoginScreen';
import { isLocalNetworkAccess, getAccessDebugInfo } from './utils/networkDetection';
...
console.log('🌐 Network Detection:', getAccessDebugInfo());
...
function AppContent() {
    ...
    if (!isAuthenticated) {
        if (isLocalNetwork) {
            // Local network → Maya Gateway (Face ID + PIN) - ALWAYS OPEN, NO CLOSE BUTTON
            return (
            ...
            // Remote access → Regular email/password login
            return <LoginScreen />;
        }
    }
...
// Main App with Maya Auth Provider
