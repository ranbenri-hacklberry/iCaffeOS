        ...
        {Object.entries(currentStats.deepStats).length === 0 ? (
          ...
          Object.entries(currentStats.deepStats)
            ...
            .map(([category, stats]) => {
              ...
              return (
                <div key={category} className="bg-white border text-sm border-gray-200 rounded-xl overflow-hidden shadow-sm transition-all hover:border-gray-300">
                  <div
        ...
        <div className="space-y-2">
          {displayedOrders.length === 0 ? (
            ...
            displayedOrders.map(order => {
              ...
              return (
                <div key={order.id} className="bg-white border text-sm border-gray-200 rounded-xl overflow-hidden shadow-sm transition-all hover:border-gray-300">
                  <div
