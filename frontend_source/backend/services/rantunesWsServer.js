...
export class RantunesWsServer {
    ...
    _handleMessage(ws, raw) {
        ...
        switch (cmd) {
            ...
            case 'UPDATE_QUEUE': return this._cmdUpdateQueue(payload);
    ...
    _cmdUpdateQueue(payload) {
        const { songs = [], currentIndex = 0 } = payload;
        this._queue.updateQueue(songs, currentIndex);
        this._broadcastState();
    }
