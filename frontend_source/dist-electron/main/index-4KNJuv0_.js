...
import { ipcMain as ipcMain$1, app as app$1 } from "electron";
...
class LogStreamer {
  ...
  startStreaming() {
    ...
    try {
      let fileSize = 0;
      try {
        fileSize = fs.statSync(this.logPath).size;
      } catch {
      }
...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-BykS2BPK.js")).MpegParser;
  }
};
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-Ce251teR.js")).AsfParser;
  }
};
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-DdG64O9s.js")).DsdiffParser;
  }
};
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-Bodq_tmA.js")).AIFFParser;
  }
};
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-_ZYLOIIo.js")).DsfParser;
  }
};
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser-CoN3io_e.js").then((n) => n.d)).FlacParser;
  }
};
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-18Pl86yU.js")).MatroskaParser;
  }
};
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-hKDjIzDP.js")).MP4Parser;
  }
};
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-BtK6BBzr.js")).MusepackParser;
  }
};
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-C9tnc6rM.js")).OggParser;
  }
};
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser-9HkTIS4G.js")).WavPackParser;
  }
};
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-CP6GaENF.js")).WaveParser;
  }
};
...
class DiscoveryService {
  constructor() {
    ...
    this.cacheDir = path.join(app$1.getPath("userData"), "cover_cache");
